//
// Created by RuoHao Li on 3/27/21.
//
...
public: 						// 顺序表的运算集
    ...
    bool prior_insert(int p, T value);
...
template <class T>
bool arrList<T> :: prior_insert(int p, const T value)  {
    int i;
    if (curLen >= maxSize)  { 		  		// 检查顺序表是否溢出
        cout << "error!"<<endl;
        return false;
